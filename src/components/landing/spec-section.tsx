      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="bg-[var(--color-bg)] border border-[var(--color-border-subtle)] rounded-xl overflow-hidden">
          <div className="flex justify-between items-center px-5 py-4 bg-[rgba(59,130,246,0.05)] border-b border-[var(--color-border-subtle)]">
            <span className="font-[family-name:var(--f-mono)] text-base font-semibold text-[var(--color-precision)]">
              RAC_SPEC.md
            </span>
            <button
              className="px-4 py-2 bg-transparent border border-[var(--color-border)] rounded-md font-[family-name:var(--f-body)] text-[0.85rem] text-[var(--color-text-secondary)] cursor-pointer transition-all duration-150 hover:bg-[rgba(59,130,246,0.1)] hover:border-[var(--color-precision)] hover:text-[var(--color-precision)]"
          ...
          >
            <CodeBlock
              code={specContent}
              language="rac"
              className="m-0 p-5 font-[family-name:var(--f-mono)] text-[0.8rem] leading-relaxed whitespace-pre-wrap border-0 rounded-none bg-transparent"
            />
          </div>
        </div>
      </div>
